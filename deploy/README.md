...
This directory provides a production baseline for the FastAPI service, durable database-backed bookkeeping worker, Redis collaboration bus, and React terminal frontend. Copy `.env.example` to `.env`, replace every placeholder secret, and start the complete stack from the repository root. Read the root [`README.md`](../README.md), [`docs/ARCHITECTURE.md`](../docs/ARCHITECTURE.md), and [`docs/ROADMAP.md`](../docs/ROADMAP.md) for verified implementation boundaries.
