...
**Primary technology:** Autodesk Fusion 360 API  
**Primary output:** Python scripts to STEP/STL  
**Domain:** Mechanical CAD

## 1. Feature Definition

Maker CAD is a Trinity AI capability defined at the product/architecture level. See the Trinity roadmap for authoritative scope.
...
- Natural-language mechanical design requirements
