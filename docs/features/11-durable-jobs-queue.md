...
**Primary technology:** SQLite-backed persistent queue  
**Primary output:** Background job execution  
**Domain:** Platform execution

## 1. Feature Definition

Durable Jobs Queue is a Trinity AI capability defined at the product/architecture level. See the Trinity roadmap for authoritative scope.
...
app/job_queue.py, app/job_worker.py
