...
**Primary technology:** arXiv Atom API  
**Primary output:** Interactive paper cards  
**Domain:** Academic research

## 1. Feature Definition

Literature RAG is a Trinity AI capability defined at the product/architecture level. See the Trinity roadmap for authoritative scope.
...
app/engines/literature_engine.py
