...
**Primary technology:** Transparent deterministic planning  
**Primary output:** Execution steps and workflow results  
**Domain:** Multi-engine planning

## 1. Feature Definition

Workflow Planner and Executor is a Trinity AI capability defined at the product/architecture level. See the Trinity roadmap for authoritative scope.
...
app/workflows.py, app/routes/workflows.py
