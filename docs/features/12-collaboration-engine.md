...
**Primary technology:** WebSockets + Redis pub/sub  
**Primary output:** Real-time collaboration rooms  
**Domain:** Platform collaboration

## 1. Feature Definition

Collaboration Engine is a Trinity AI capability defined at the product/architecture level. See the Trinity roadmap for authoritative scope.
...
app/collab.py, app/routes/collab.py
