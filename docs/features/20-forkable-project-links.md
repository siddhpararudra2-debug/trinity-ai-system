# Forkable Project Links

**Primary technology:** Project sharing layer  
**Primary output:** Public forkable project URLs  
**Domain:** Sharing

## 1. Feature Definition

Forkable Project Links is a Trinity AI capability defined at the product/architecture level. See the Trinity roadmap for authoritative scope.
