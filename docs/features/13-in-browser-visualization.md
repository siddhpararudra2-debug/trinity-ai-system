# In-Browser CAD and PCB Visualization

**Primary technology:** WebGL/Three.js + SVG  
**Primary output:** Immediate 3D CAD and PCB previews  
**Domain:** Visual verification

## 1. Feature Definition

In-Browser CAD and PCB Visualization is a Trinity AI capability defined at the product/architecture level. See the Trinity roadmap for authoritative scope.
...
- Generated STL/CAD artifacts
- PCB/schematic visualization data

## 4. Outputs

- Interactive 3D CAD preview
- PCB/schematic preview
- Visual verification experience
...
artifacts/trinity/src/components/preview/
