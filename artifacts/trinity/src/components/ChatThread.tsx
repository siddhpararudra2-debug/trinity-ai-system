...
export function ChatThread({ conversationId }: { conversationId: number | null }) {
  const { data: messages, isLoading } = useGetMessages(conversationId as number, { query: { enabled: !!conversationId } });
