...
- **Routing:** Keyword/regex orchestrator in `app/unified_router/orchestrator.py`
...
- **Keyword routing:** Engine selection uses regex matching in the orchestrator; no LLM call needed.
