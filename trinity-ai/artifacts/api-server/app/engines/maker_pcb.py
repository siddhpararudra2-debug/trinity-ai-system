...
class MakerPcbEngine:
    ...
    def _schematic(self, description: str, board_type: str) -> str:
        ...
        if board_type == "Arduino-Shield":
            mcu_name = "ATMEGA328P-AU"
            mcu_lib = "MCU_Microchip_ATmega:ATmega328P-AU"
            mcu_fp = "Package_QFP:TQFP-32_7x7mm_P0.8mm"
        elif board_type == "STM32-Board":
            mcu_name = "STM32F103C8Tx"
            mcu_lib = "MCU_ST_STM32F1:STM32F103C8Tx"
            mcu_fp = "Package_QFP:LQFP-48_7x7mm_P0.5mm"
        else: # default to ESP32
            mcu_name = "ESP32-WROOM-32"
            mcu_lib = "MCU_Module:ESP32-WROOM-32"
            mcu_fp = "RF_Module:ESP32-WROOM-32"
...
(kicad_sch
  ...
  (lib_symbols
    (symbol "{mcu_lib}"
      ...
      (property "Value" "{mcu_name}" (at 0 -33 0)
        (effects (font (size 1.27 1.27))))
      (property "Footprint" "{mcu_fp}" (at 0 0 0)
  ...
  (symbol (lib_id "{mcu_lib}") (at 100 80 0) (unit 1)
    (in_bom yes) (on_board yes)
    (property "Reference" "U1" (at 100 45 0))
    (property "Value" "{mcu_name}" (at 100 116 0))
...
(kicad_pcb
  ...
  (net 3 "GPIO0")
  (net 4 "GPIO2")
  (footprint "{mcu_fp}" (layer "F.Cu")
    (descr "{mcu_name} module")
    (at 100 100)
    (property "Reference" "U1" (at 0 -20 0) (layer "F.SilkS"))
    (property "Value" "{mcu_name}" (at 0 20 0) (layer "F.Fab"))
    (attr through_hole)
